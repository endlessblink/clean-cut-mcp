 ...
 */
export async function extractBrandPalette(logoPath, fallbackStyle = 'tech') {
 ...
 */
export function getDefaultPalette(style) {
    const palettes = {
        tech: {
 ...
 */
export function mapColorsToRoles(extractedColors) {
 ...
 */
function findMostSaturatedColor(colors) {
    return colors.reduce((mostSaturated, color) => color.hsl.s > mostSaturated.hsl.s ? color : mostSaturated, colors[0]);
}
/**
