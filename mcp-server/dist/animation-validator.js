...
export class AnimationValidator {
     ...
     */
    async checkSyntaxErrors(sourceFile, result) {
     ...
     */
    async checkReactComponent(sourceFile, result, componentName) {
     ...
     */
    async checkRemotionImports(sourceFile, result) {
     ...
     */
    async checkTypeScriptTypes(sourceFile, result, componentName) {
     ...
     */
    attemptAutoFixes(code, errors, componentName) {
        let fixedCode = code;
     ...
     */
    shouldIgnoreDiagnostic(message) {
