...
exports.BASE_ANIMATION_RULES = void 0;
exports.enforceBaseRules = enforceBaseRules;
exports.BASE_ANIMATION_RULES = {
 ...
 */
function enforceBaseRules(spec) {
    const violations = [];
    // Check font
    ...
    const missingBlur = spec.scenes?.some(s => s.elements?.some(e => (e.velocity && e.velocity > 3) && !s.hasMotionBlur));
    if (missingBlur) {
